...
status:merged AND owner:"Ji Tingting(纪廷廷) <tingting.ji@reallytek.com>"  OR owner:"Xu Xiaodong(徐晓东) <xiaodong.xu@reallytek.com>"  OR owner:"Yang Bincai（杨斌才） <bincai.yang@reallytek.com>" OR owner:"Li Jun(李君) <jun.li@reallytek.com>"   OR owner:"Zhang Guoliang(张国梁) <guoliang.zhang@reallytek.com>" OR owner:"Song Zeyou(宋泽友) <zeyou.song@reallytek.com>" OR owner:"Yu Qiwen(余启文) <qiwen.yu@reallytek.com>"  OR  owner:"Xie Zheng(谢政) <zheng.xie@reallytek.com>"  OR owner:"Shi Xinxin(史新新) <xinxin.shi@reallytek.com>"
